...
export const nl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Op mobiel? Kopieer de volledige URL (inclusief #token=...) vanuit agentops dashboard --no-open op je desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — authenticeer opnieuw met agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Plak het token uit agentops dashboard --no-open of voer het geconfigureerde wachtwoord in.",
        stepGenerate:
          "Als er geen token is geconfigureerd, voer dan agentops doctor --generate-gateway-token uit op de Gateway-host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Voer agentops dashboard --no-open uit en open de nieuwe URL of plak het token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Voer agentops devices list uit op de Gateway-host.",
        stepApproveId: "Keur deze aanvraag goed: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Open het geserveerde dashboard opnieuw met agentops dashboard zodat UI en Gateway uit dezelfde installatie komen.",
        stepDevUi:
          "Als je pnpm ui:dev gebruikt, bouw of herstart de dev-UI tegen de huidige checkout.",
        stepRestart:
          "Herstart de Gateway na het bijwerken van AgentOps zodat het huidige protocol wordt geserveerd.",
      },
      network: {
        ...
        stepGateway: "Bevestig dat de Gateway draait met agentops status of agentops gateway run.",
        stepUrl:
          "Controleer de WebSocket-URL en gebruik wss:// wanneer de Gateway achter HTTPS/Tailscale Serve staat.",
        stepDashboard:
          "Open het dashboard opnieuw met agentops dashboard --no-open om de huidige URL en authdetails opnieuw te kopiëren.",
      },
    },
  },
  chat: {
