...
export const ar: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من agentops dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "الصق الرمز المميز من agentops dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل agentops doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل agentops dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل agentops devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "أعد فتح لوحة المعلومات المقدمة باستخدام agentops dashboard حتى يأتي UI وGateway من التثبيت نفسه.",
        stepDevUi:
          "إذا كنت تستخدم pnpm ui:dev، فأعد بناء أو تشغيل واجهة التطوير مقابل checkout الحالي.",
        stepRestart: "أعد تشغيل Gateway بعد تحديث AgentOps حتى يقدم البروتوكول الحالي.",
      },
      network: {
        title: "تعذر الاتصال",
        summary:
          "لم يتمكن المتصفح من إكمال اتصال Gateway. تحقق من الهدف والنقل قبل إعادة تجربة بيانات الاعتماد.",
        stepGateway: "تأكد من أن Gateway يعمل باستخدام agentops status أو agentops gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام agentops dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  chat: {
