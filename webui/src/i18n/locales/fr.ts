...
export const fr: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis agentops dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Collez le jeton de agentops dashboard --no-open ou saisissez le mot de passe configuré.",
        stepGenerate:
          "Si aucun jeton n’est configuré, exécutez agentops doctor --generate-gateway-token sur l’hôte Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Exécutez agentops dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Exécutez agentops devices list sur l’hôte Gateway.",
        stepApproveId: "Approuvez cette demande : agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Rouvrez le dashboard servi avec agentops dashboard afin que l’UI et le Gateway viennent de la même installation.",
        stepDevUi:
          "Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.",
        stepRestart:
          "Redémarrez le Gateway après la mise à jour d’AgentOps afin qu’il serve le protocole actuel.",
      },
      network: {
        ...
        stepGateway:
          "Confirmez que le Gateway fonctionne avec agentops status ou agentops gateway run.",
        stepUrl:
          "Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.",
        stepDashboard:
          "Rouvrez le dashboard avec agentops dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.",
      },
    },
  },
  chat: {
