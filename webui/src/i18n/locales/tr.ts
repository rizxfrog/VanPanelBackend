...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "agentops.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde agentops dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — agentops models auth ile yeniden kimlik doğrulayın",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "agentops dashboard --no-open çıktısındaki tokenı yapıştırın veya yapılandırılmış parolayı girin.",
        stepGenerate:
          "Token yapılandırılmamışsa Gateway ana makinesinde agentops doctor --generate-gateway-token çalıştırın.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "agentops dashboard --no-open çalıştırın ve yeni URL’yi açın veya tokenını yapıştırın.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Gateway hostunda agentops devices list çalıştırın.",
        stepApproveId: "Bu isteği onaylayın: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "UI ve Gateway aynı kurulumdan gelsin diye sunulan dashboardı agentops dashboard ile yeniden açın.",
        stepDevUi:
          "pnpm ui:dev kullanıyorsanız geliştirme UI’sini mevcut checkouta göre yeniden derleyin veya yeniden başlatın.",
        stepRestart:
          "AgentOps güncellemesinden sonra Gateway’i yeniden başlatın, böylece güncel protokolü sunsun.",
      },
      network: {
        title: "Bağlanılamadı",
        summary:
        ...
        stepGateway:
          "agentops status veya agentops gateway run ile Gateway’in çalıştığını doğrulayın.",
        stepUrl:
          "WebSocket URL’sini kontrol edin ve Gateway HTTPS/Tailscale Serve arkasındaysa wss:// kullanın.",
        stepDashboard:
          "Geçerli URL ve auth ayrıntılarını yeniden kopyalamak için dashboardı agentops dashboard --no-open ile yeniden açın.",
      },
    },
  },
  chat: {
