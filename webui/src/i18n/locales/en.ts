...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from agentops dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run agentops devices list on the Gateway host.",
        stepApproveId: "Approve this request: agentops devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with agentops status or agentops gateway run.",
        stepUrl:
