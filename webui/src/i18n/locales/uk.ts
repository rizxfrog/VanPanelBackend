...
export const uk: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Редагування agentops.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з agentops dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Вставте токен з agentops dashboard --no-open або введіть налаштований пароль.",
        stepGenerate:
          "Якщо токен не налаштовано, виконайте agentops doctor --generate-gateway-token на хості Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Виконайте agentops dashboard --no-open і відкрийте свіжий URL або вставте його токен.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Виконайте agentops devices list на хості Gateway.",
        stepApproveId: "Схваліть цей запит: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Знову відкрийте наданий dashboard через agentops dashboard, щоб UI і Gateway походили з однієї інсталяції.",
        stepDevUi:
          "Якщо використовуєте pnpm ui:dev, перебудуйте або перезапустіть dev UI з поточного checkout.",
        stepRestart:
          "Перезапустіть Gateway після оновлення AgentOps, щоб він надавав поточний протокол.",
      },
      network: {
        ...
        stepGateway:
          "Підтвердьте, що Gateway працює, через agentops status або agentops gateway run.",
        stepUrl:
          "Перевірте WebSocket URL і використовуйте wss://, коли Gateway знаходиться за HTTPS/Tailscale Serve.",
        stepDashboard:
          "Знову відкрийте dashboard через agentops dashboard --no-open, щоб повторно скопіювати поточний URL і деталі auth.",
      },
    },
  },
  chat: {
