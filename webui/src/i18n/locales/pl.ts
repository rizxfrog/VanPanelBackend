...
export const pl: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z agentops dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Wklej token z agentops dashboard --no-open albo wpisz skonfigurowane hasło.",
        stepGenerate:
          "Jeśli token nie jest skonfigurowany, uruchom agentops doctor --generate-gateway-token na hoście Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Uruchom agentops dashboard --no-open i otwórz świeży URL albo wklej jego token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Uruchom agentops devices list na hoście Gateway.",
        stepApproveId: "Zatwierdź to żądanie: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Otwórz ponownie udostępniany dashboard poleceniem agentops dashboard, aby UI i Gateway pochodziły z tej samej instalacji.",
        stepDevUi:
          "Jeśli używasz pnpm ui:dev, przebuduj lub uruchom ponownie UI dev względem bieżącego checkoutu.",
        stepRestart:
          "Zrestartuj Gateway po aktualizacji AgentOps, aby udostępniał bieżący protokół.",
      },
      network: {
        ...
        stepGateway:
          "Potwierdź, że Gateway działa, używając agentops status lub agentops gateway run.",
        stepUrl: "Sprawdź URL WebSocket i użyj wss://, gdy Gateway jest za HTTPS/Tailscale Serve.",
        stepDashboard:
          "Otwórz ponownie dashboard przez agentops dashboard --no-open, aby skopiować bieżący URL i szczegóły auth.",
      },
    },
  },
  chat: {
