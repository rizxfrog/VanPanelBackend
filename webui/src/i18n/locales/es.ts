...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.agentops/agentops.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde agentops dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — vuelve a autenticarte con agentops models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Pega el token de agentops dashboard --no-open o introduce la contraseña configurada.",
        stepGenerate:
          "Si no hay token configurado, ejecuta agentops doctor --generate-gateway-token en el host del Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Ejecuta agentops dashboard --no-open y abre la URL nueva o pega su token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Ejecuta agentops devices list en el host del Gateway.",
        stepApproveId: "Aprueba esta solicitud: agentops devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Vuelve a abrir el dashboard servido con agentops dashboard para que UI y Gateway provengan de la misma instalación.",
        stepDevUi:
          "Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.",
        stepRestart:
          "Reinicia el Gateway después de actualizar AgentOps para que sirva el protocolo actual.",
      },
      network: {
        ...
        stepGateway:
          "Confirma que el Gateway esté en ejecución con agentops status u agentops gateway run.",
        stepUrl:
          "Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Vuelve a abrir el dashboard con agentops dashboard --no-open para copiar la URL y los detalles de autenticación actuales.",
      },
    },
  },
  chat: {
