...
const SENDER_METADATA_BLOCK =
  'Sender (untrusted metadata):\n```json\n{"label":"agentops-control-ui","id":"agentops-control-ui"}\n```';
      ...
      messages: [
        {
          ...
          senderLabel: "agentops-control-ui",
          timestamp: 1,
        },
      ],
    });
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_nearest_turn",
              url: "/__agentops__/canvas/documents/cv_nearest_turn/index.html",
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_empty_anchor",
              url: "/__agentops__/canvas/documents/cv_empty_anchor/index.html",
          ...
          content: JSON.stringify({
            selected_item: {
              ...
              view: {
                ...
                url: "/__agentops__/canvas/documents/cv_generic_inline/index.html",
            ...
            },
            {
              ...
              text: JSON.stringify({
                ...
                view: {
                  ...
                  url: "/__agentops__/canvas/documents/cv_streamed_artifact/index.html",
                  title: "Streamed demo",
                  preferred_height: 320,
                },
                presentation: {
...
function createAssistantCanvasBlock(params: { suffix: string }) {
  ...
  return {
    ...
    preview: {
      ...
      viewId,
      title: "Inline demo",
      url: `/__agentops__/canvas/documents/${viewId}/index.html`,
      preferredHeight: 360,
    },
  };
}
